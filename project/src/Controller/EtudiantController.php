...
class EtudiantController extends AbstractController
{
    ...
    public function export(AnneeFormation $anneeFormation, ExportStudentService $exportStudentService): Response
    {
        $exportStudentService->prepareSpreadsheet($anneeFormation);
        $temp_file = $exportStudentService->saveSpreadsheet($anneeFormation);

        return $this->file($temp_file, "IP_MASTER_MIAGE_{$anneeFormation->getLabel()}.xlsx");
    }
